...
#Assume file_name is in the same directory as the script
path = os.path.join(os.path.dirname(__file__), file_name)
ecg = ECGXMLReader(path)
...
np_path = os.path.join(os.path.dirname(__file__), np_file_name)
np.save(np_path, all_leads)

#Just for testing:
# #Load the data from the numpy file
loaded_data = np.load(np_path, allow_pickle=True)
